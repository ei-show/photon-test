...
var DemoLoadBalancing = /** @class */ (function (_super) {
    ...
    function DemoLoadBalancing() {
        ...
        _this.logger.info("Photon Version: " + Photon.Version);
    ...
    DemoLoadBalancing.prototype.setupUI = function () {
        ...
        btnJoinOrCreate.onclick = function (ev) {
            if (_this.isInLobby()) {
                ...
                _this.joinRoom(gameId.value.length > 0 ? gameId.value : undefined, { createIfNotExists: true, expectedUsers: expectedUsers.value.length > 0 ? expectedUsers.value.split(",") : undefined }, { emptyRoomLiveTime: 20000, suspendedPlayerLiveTime: 20000, maxPlayers: 6 });
